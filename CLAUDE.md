...
lit_review/
  papers/            # Raw PDFs organized by topic/category (not version-controlled)
  paper_summaries/   # Markdown summaries generated by /create-paper-summary

paper/
  main.tex           # LaTeX manuscript
  main.bib           # BibTeX bibliography
  outline.md         # Structured paper outline
```
